...
SPAN_DOCS = [
    {
        ...
        "qa": [
            ...
            {"q": "How many leaves are numbered in the book?",
             "a": "one thousand one hundred and forty-four", "type": "number",
    ...
    },
    {
        ...
        "qa": [
            ...
            {"q": "How tall is the structure from its base to the lamp?",
             "a": "ninety-eight feet", "type": "number",
    ...
    },
    {
        ...
        "qa": [
            ...
            {"q": "How many casks does a good harvest produce?", "a": "seventy-two",
    ...
    },
    {
        ...
        "qa": [
            ...
            {"q": "How many workers did the mint employ at its peak?",
             "a": "three hundred and sixteen", "type": "number",
    ...
    },
    {
        ...
        "qa": [
            ...
            {"q": "How steep is the line at its sharpest?", "a": "one in three",
